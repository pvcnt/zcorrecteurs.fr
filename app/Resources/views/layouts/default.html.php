	...
	<body>
		...
		<div id="body">
			...
			<div id="admin_rapide">
				...
				<?php } if(verifier('blog_voir_billets_proposes')){ $billets = \Container::getService('zco_admin.manager')->get('blog'); ?>
				<div class="admin_lien">
				...
				<?php } if(verifier('recrutements_voir_candidatures')){ $candidatures = \Container::getService('zco_admin.manager')->get('recrutement'); ?>
				<div class="admin_lien">
				...
				<?php } if(verifier('zcorriger') || verifier('voir_tutos_attente')){ $tutos = \Container::getService('zco_admin.manager')->get('zcorrection'); ?>
				<div class="admin_lien">
