...
var DatePicker = new Class({
	...
	attach: function() {
		...
		$$(this.attachTo).each(function(item, index) {
			...
			.erase('required') // ajout pour empêcher un bug de Chrome
			.erase('maxlength') // ajout pour empêcher un bug de Chrome
			.clone()
			...
			// désactive la validation HTML5 de l'élément, cf bug de Chrome #45640
