            ...
            <div class="accordion" id="pub-accordion">
                ...
                <div class="accordion-group">
                    ...
                    <div id="pub-ciblage" class="accordion-body collapse">
                        <div class="accordion-inner">
                            <strong>Ciblage par section.</strong> 
                            <span class="gris">N'affiche la publicité que sur certaines sections du site.</span><br />
                            ...
                            <div id="row_cibler_categories">
                                ...
                                <?php foreach ($categories as $i => $cat){ ?>
                                    ...
                                    <label for="cat_<?php echo $cat['id'] ?>" id="label_<?php echo $cat['id'] ?>" class="lbl_cat nofloat">
                                        <?php echo htmlspecialchars($cat['nom']) ?>
                                    </label>

                                    <?php if ($cat['ciblage_actions']){ ?>
                                    <input type="checkbox" name="index_<?php echo $cat['id'] ?>" id="index_<?php echo $cat['id'] ?>" onclick="if (this.checked && !$('cat_<?php echo $cat['id'] ?>').checked){ $('cat_<?php echo $cat['id'] ?>').set('checked', true); $('label_<?php echo $cat['id'] ?>').addClass('vertf'); }" style="margin-left: 15px;" />
