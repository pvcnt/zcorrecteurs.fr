...
<form method="post" action="">
	...
	<div class="form-actions">
        ...
        <a href="publicite-<?php echo $publicite['id'] ?>.html" class="btn">Annuler</a>
	</div>
</form>
