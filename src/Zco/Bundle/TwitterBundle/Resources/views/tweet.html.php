<div class="UI_box box message" id="t<?php echo $tweet['twitter_id'] ?>">
    <p>
        <a style="float: right"
           href="http://twitter.com/<?php echo rawurlencode($tweet['nom_compte']) ?>/status/<?php echo $tweet['twitter_id'] ?>"
        >
            <img src="/bundles/zcotwitter/img/bouton.png" alt="Twitter" title="Voir sur Twitter" />
        </a>
        ...
        <em>
            via
            <a href="http://twitter.com/<?php echo rawurlencode($tweet['nom_compte']) ?>">
