...
<div class="row-fluid" style="margin-top: 20px;">
	<div class="span9" style="padding-right: 10px; border-right: 1px solid #EEE;">
		<div class="pill-content">
			...
			<?php endif ?>
			<?php if ($canSeeAdmin): ?>
			<div class="pill-pane" id="profile-admin">
				<?php echo $view->render('ZcoUserBundle:Profile:_admin.html.php', compact('user')) ?>
			</div>
			<?php endif ?>
		</div> <!-- /.pill-content -->
	</div> <!-- /.span9 -->
	...
	<div class="span3">
		<?php if ($canSeeInfos || $canSeeAdmin) :?>
		<ul class="nav nav-pills nav-stacked" style="margin-bottom: 15px;">
		    ...
		    <?php if ($canSeeInfos): ?>
		  	...
		  	<?php endif ?>
		  	<?php if ($canSeeAdmin): ?>
		  	<li><a href="#profile-admin" data-toggle="pill">Administrer</a></li>
		  	<?php endif ?>
		</ul>
		<?php endif ?>
        ...
        <div style="margin-top: 5px;">
			<a class="btn btn-success" href="/options/" style="display: inline-block; width: 80%;">
		...
		<div>
			<a class="btn btn-success" 
			    ...
			    <?php if ($canSendEmail): ?>
			    href="mailto:<?php echo htmlspecialchars($user->getEmail()) ?>"
				<?php else: ?>
		...
		<div style="margin-top: 5px;"><div class="btn-group">
            <a class="btn dropdown-toggle" style="display: inline-block; width: 80%;" data-toggle="dropdown" href="#">
            	...
            	<?php echo $_SESSION['id'] == $user->getId() ? 'Mon' : 'Son' ?> activité sur le site
            	<span class="caret"></span>
            </a>
            <ul class="dropdown-menu">
            	<li>
            		<a href="/forum/detail-messages-<?php echo $user->getId(); ?>.html">
            			Détail de <?php echo $_SESSION['id'] == $user->getId() ? 'mon' : 'son' ?> 
	            ...
	            <li>
	            	<a href="/forum/sujets-participe-<?php echo $user->getId(); ?>.html">
	            		Les sujets auxquels 
	            		<?php echo $_SESSION['id'] == $user->getId() ? 'j\'ai' : 'il a' ?> 
	            		participé
	            	</a>
	            </li>
	            <li class="divider"></li>
	        	...
	        	<?php if(verifier('quiz_stats')|| $_SESSION['id'] == $user->getId()): ?>
	            	<li>
	            		<a href="/quiz/mes-statistiques-<?php echo $user->getId(); ?>.html">
	            			<?php echo $_SESSION['id'] == $user->getId() ? 'Mes' : 'Ses' ?> statistiques de quiz
	            		</a>
	            	</li>
	        	<?php endif ?>
            </ul>
