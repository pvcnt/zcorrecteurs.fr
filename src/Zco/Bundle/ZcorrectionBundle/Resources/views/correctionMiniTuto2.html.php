...
<?php /* Ce fichier sert à réaliser la correction d'une sous partie d'un big-tuto (cette sous partie étant un mini-tuto). */ ?>
...
//Introduction
echo '<a class="zco_marque" href="#" onclick="drop_zco_mark('.($s['recorrection_id'] ? $s['recorrection_id'] : $s['correction_id']).', \'texte-mini-intro-'.$InfosTuto['mini_tuto_id'].'\');" title="Déposer la marque de correction ici"><img src="/img/zcorrection/marque.png" alt="Laisser la marque de correction" /></a>';
...
if($parties){
	foreach ($parties as $p)
	{
		...
		{
			echo '<a class="zco_marque" href="#" onclick="drop_zco_mark('.($s['recorrection_id'] ? $s['recorrection_id'] : $s['correction_id']).', \'texte-sous_partie-'.$p['sous_partie_id'].'-'.$num.'\');" title="Déposer la marque de correction ici"><img src="/img/zcorrection/marque.png" alt="Laisser la marque de correction" /></a>';
...
//Conclusion
echo '<a class="zco_marque" href="#" onclick="drop_zco_mark('.($s['recorrection_id'] ? $s['recorrection_id'] : $s['correction_id']).', \'texte-mini-ccl-'.$InfosTuto['mini_tuto_id'].'\');" title="Déposer la marque de correction ici"><img src="/img/zcorrection/marque.png" alt="Laisser la marque de correction" /></a>';
...
else
{
	foreach($qcm as $q)
	{
		echo '<a class="zco_marque" href="#" onclick="drop_zco_mark('.($s['recorrection_id'] ? $s['recorrection_id'] : $s['correction_id']).', \'texte-qcm-question-'.$q['question_id'].'\');" title="Déposer la marque de correction ici"><img src="/img/zcorrection/marque.png" alt="Laisser la marque de correction" /></a>';
